...
describe('User visibility based on role', () => {
	let visitPage = '/users';
	...
	it('should create an ADMIN user', () => {
		...
		cy.wait('@createAdmin').then(interception => {
			...
			createdAdmin = { ...createdAdmin, ...interception.response.body.user };
		});
	});
	...
	it('should log in as ADMIN and see multiple users', () => {
		loginCredentials = {
			...devCredentials,
		};
	});
	...
	it('should log in as USER and see only their own account', () => {
		loginCredentials = {
			...devCredentials,
		};
	});
