...
describe('Create building view as user', () => {
	...
	it('should create a new USER user', () => {
	...
	it('should update user password', () => {
		cy.get('[data-testid="user-search"] input').clear().type(newUser.username);
