...
import { useHPSlvStatus } from './useHpSlvStatus';

interface HpSlv2Props extends Pick<DrawViewItemValueComponentProps, 'arg1' | 'arg2' | 'arg3' | 'unitXid' | 'xidPreffixFilter' | 'editing'> {}
const HpSlv2: React.FC<HpSlv2Props> = ({ xidPreffixFilter, arg1, arg2, unitXid, editing }) => {
	const { isWorking, mode, tempRenderedValue } = useHPSlvStatus(xidPreffixFilter, arg2);
...
interface HpSlv2ViewProps extends Pick<DrawViewItemValueComponentProps, 'arg1' | 'unitXid' | 'editing'> {
	isWorking: boolean;
...
const HpSlv2View: React.FC<HpSlv2ViewProps> = ({ isWorking, mode, isAlarmActive, arg1, unitXid, editing, isComAlarm, alarmsCount, tempRenderedValue }) => {
