...
import { DrawViewItemAhuComponentProps } from './DrawViewItemAhuComponent';

export interface DrawViewItemAhuEditorProps {
	item: DrawViewItemAhuComponentProps;
	actions: EditingViewStateActions;
	view: DrawView;
}

const DrawViewItemAhuEditor: React.FC<DrawViewItemAhuEditorProps> = ({ item, actions, view }) => {
	...
	return (
		<>
			<EditorFormGroup topSeparator label='view_editor.items.ahu'>
...
export default DrawViewItemAhuEditor;
