...
import { DrawViewItemCoolerComponentProps } from './DrawViewItemCoolerComponent';

export interface DrawViewItemCoolerEditorProps {
	item: DrawViewItemCoolerComponentProps;
	actions: EditingViewStateActions;
	view: DrawView;
}

const DrawViewItemCoolerEditor: React.FC<DrawViewItemCoolerEditorProps> = ({ item, actions, view }) => {
	...
	return (
		<>
			<EditorFormGroup topSeparator label='view_editor.items.cooler'>
...
export default DrawViewItemCoolerEditor;
