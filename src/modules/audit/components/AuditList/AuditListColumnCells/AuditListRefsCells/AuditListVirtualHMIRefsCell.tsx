...
const AuditListVirtualHMIRefsCell: React.FC<
	SuperTableCustomCellProps<VirtualHMIAuditEventDetails> & { updateSettingsDataHandler: (ob: Partial<AuditListRoutingPagitnationProps>) => void }
> = ({ value, updateSettingsDataHandler }) => {
	...
	return (
		<>
			<span>
				{t('audit.messages.login_to', { to: 'VirtualHMI' })}
...
export default AuditListVirtualHMIRefsCell;
