...
const AuditListEventAcknowledgeRefsCell: React.FC<
	SuperTableCustomCellProps<EventAcknowledgeEventDetails> & { updateSettingsDataHandler: (ob: Partial<AuditListRoutingPagitnationProps>) => void }
> = ({ value, updateSettingsDataHandler }) => {
	...
	return (
		<>
			<span>
				{t('audit.messages.event_acknowledge')}
...
export default AuditListEventAcknowledgeRefsCell;
